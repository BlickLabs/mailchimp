...
MAILCHIMP_DONDINERO_API_KEY = env("MAILCHIMP_DONDINERO_API_KEY")
MAILCHIMP_DONDINERO_SHARD = env("MAILCHIMP_DONDINERO_SHARD")
MAILCHIMP_DONDINERO_API_ROOT = "https://" + MAILCHIMP_DONDINERO_SHARD + ".api.mailchimp.com/3.0/"
